...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   dotspacemacs-themes '(grandshell spacemacs-dark
                         spacemacs-light)
...
(defun dotspacemacs/user-config ()
  ...
  (slack-register-team
   :name "mpq"
   :token (password-store-get 'mpqsoftware.slack.com)
   :subscribed-channels '(prewoe magnus linus perlennartson random general slackbot)
   )
